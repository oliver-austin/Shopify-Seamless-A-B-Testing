...
tslib_1.__decorate([decorators.debounce(40, {
  leading: true,
  trailing: true,
  maxWait: 40
}), decorators.autobind], StickyManager.prototype, "handleResize", null);

tslib_1.__decorate([decorators.debounce(40, {
  leading: true,
  trailing: true,
  maxWait: 40
}), decorators.autobind], StickyManager.prototype, "handleScroll", null);
...
function (_React$PureComponent) {
  ...
  _createClass(TextField, [{
    ...
    value: function handleButtonPress(onChange) {
      ...
      events.addEventListener(document, 'mouseup', this.handleButtonRelease, {
        once: true
      });
    }
  }, {
