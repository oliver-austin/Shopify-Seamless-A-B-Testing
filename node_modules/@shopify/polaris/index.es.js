...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '3.10.0';
}

var polarisVersion = '3.10.0';
...
__decorate([debounce(40, {
  leading: true,
  trailing: true,
  maxWait: 40
}), autobind], StickyManager.prototype, "handleResize", null);

__decorate([debounce(40, {
  leading: true,
  trailing: true,
  maxWait: 40
}), autobind], StickyManager.prototype, "handleScroll", null);
...
function (_React$Component) {
  ...
  _createClass(BaseItem, [{
    ...
    value: function render() {
      ...
      var iconMarkup = iconBody ? createElement("div", {
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var selectButtonMarkup = this.selectable ? createElement("div", {
        ...
        disabled: selectMode,
        icon: EnableSelectionMinor // eslint-disable-next-line react/jsx-no-bind
        ,
