...
/*#__PURE__*/
function () {
  function Product(productID, shopID, originalTitle, originalImage, originalDescription, originalDailySalesAverage, originalDaysListed, originalTotalSales, testTitle, testImage, testDescription, testDailySalesAverage, testDaysListed, testTotalSales, originalFlag) {
...
/*#__PURE__*/
function () {
  function Variant(variantID, productID, shopID, originalDisplayName, originalImage, originalPrice, originalDiscount, originalDailySalesAverage, originalDaysListed, originalTotalSales, testDisplayName, testImage, testPrice, testDiscount, testDailySalesAverage, testDaysListed, testTotalSales, originalFlag) {
  ...
  function CreateTestVariant(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "handleProductOrVariantSubmit", function (data, shopID) {
      ...
      switch (_this.state.productSelected) {
        case "product":
          var product = new _data_classes_product_Product__WEBPACK_IMPORTED_MODULE_18___default.a(data.nodes[0].id, shopID, data.nodes[0].title, data.nodes[0].images.edges[0].node.originalSrc, data.nodes[0].description, 0, 0, 0, _this.state.productTitle, _this.state.productImage, _this.state.productDescription, 0, 0, 0, 1);
